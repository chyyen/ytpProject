...
const box = document.querySelector('div.box:nth-child(1)')
...
function LoadInfo(){
    // js part
    console.log(userWalletAccount)
    provider = new ethers.providers.Web3Provider(window.ethereum);
	contract = new ethers.Contract(contractAddress, contractABI, provider)
    // html part
    Address.innerText = userWalletAccount
    Chain.innerText = network[window.ethereum.networkVersion]
    box.innerHTML = userWalletAccount
}
